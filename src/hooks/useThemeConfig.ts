...
export const THEME_PRESETS: ThemeConfig[] = [
  ...
  },
  {
    ...
    name: "Raksha Bandhan",
    emoji: "🪢",
    description: "Sibling love in saffron & maroon",
    colors: {
      background: "30 30% 97%",
      foreground: "15 30% 12%",
      primary: "15 70% 45%",
    ...
    bannerText: "🪢 Happy Raksha Bandhan! Celebrate the bond with sweet cakes!",
    bannerEmoji: "🎁",
    bannerBg: "15 70% 45%",
    bannerTextColor: "0 0% 100%",
  },
  {
    ...
    emoji: "🇮🇳",
    description: "Tricolor pride — saffron, white & green",
    colors: {
    ...
    bannerText: "🇮🇳 Happy Independence Day! Order tricolor themed cakes!",
    bannerEmoji: "🎉",
    bannerBg: "145 55% 35%",
    bannerTextColor: "0 0% 100%",
  },
  {
    ...
    name: "Onam",
    emoji: "🌸",
    description: "Kerala's harvest — floral gold & green",
    colors: {
      background: "45 25% 97%",
      foreground: "90 20% 12%",
      primary: "90 45% 38%",
    ...
    bannerText: "🌸 Happy Onam! Celebrate with our festive pookalam cakes!",
    bannerEmoji: "🚣",
    bannerBg: "90 45% 38%",
    bannerTextColor: "0 0% 100%",
  },
  {
    ...
    name: "Pongal",
    emoji: "🌾",
    description: "Harvest warmth — earthy terracotta & gold",
    colors: {
      background: "35 25% 97%",
      foreground: "20 25% 12%",
      primary: "20 60% 42%",
    ...
    bannerText: "🌾 Happy Pongal! Sweeten the harvest with our special cakes!",
    bannerEmoji: "☀️",
    bannerBg: "20 60% 42%",
    bannerTextColor: "0 0% 100%",
  },
