...
import { GripVertical, Eye, EyeOff, Save, RotateCcw, ChevronDown, ChevronUp, Plus, Trash2, Copy, Type, Megaphone, Grid3X3, HelpCircle, Minus, Image } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        {config.sections.filter(s => !isBuiltin(s.id)).map(section => (
          <SectionEditor
            key={section.id}
            id={section.id}
